...
mod serialization_tests {
    ...
    fn test_serialization_and_deserialization() {
        let key_pair = ECDSAKeyPair::generate_key_pair().expect("Failed to generate key pair");
    ...
    fn test_invalid_deserialization() {
        ...
        let result = ECDSAKeyPair::from_bytes(&invalid_bytes);
    ...
    fn test_partial_key_serialization() {
        ...
        let result = ECDSAKeyPair::from_bytes(partial_serialized);
        assert!(result.is_err());
    }
